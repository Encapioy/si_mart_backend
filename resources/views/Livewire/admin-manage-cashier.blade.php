            ...
            <div class="overflow-y-auto flex-1 p-0 relative" wire:loading.class="!overflow-hidden">
                ...
                <div wire:loading.flex wire:key="loading-overlay"
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-xs font-bold text-blue-600 animate-pulse">Memuat data...</span>
                    </div>
                </div>

                @if($selectedCashierId && count($historyTopups) > 0)
                    <table class="w-full text-left text-sm">
                        <thead class="bg-slate-50 text-slate-500 font-bold border-b border-slate-100 sticky top-0 z-10 shadow-sm">
                            <tr>
