    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-sm border border-slate-100">
        ...
        <form wire:submit="login">
            <div class="mb-4">
                ...
                <input wire:model="username" type="text" class="w-full bg-slate-50 border border-transparent focus:bg-white focus:border-blue-500 rounded-lg px-4 py-3 text-sm font-semibold text-slate-800 outline-none transition">
            </div>

            <div class="mb-6">
                <label class="block text-[10px] font-bold text-slate-400 uppercase mb-1">Password</label>
                <input wire:model="password" type="password" class="w-full bg-slate-50 border border-transparent focus:bg-white focus:border-blue-500 rounded-lg px-4 py-3 text-sm font-semibold text-slate-800 outline-none transition">
            </div>
