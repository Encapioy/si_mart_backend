<div class="min-h-screen bg-slate-50 text-slate-800 flex flex-col p-6">
    ...
    <div class="bg-white p-4 rounded-xl flex items-center space-x-3 mb-8 border border-slate-200 shadow-sm">
        ...
        <div>
            ...
            <p
                class="text-[10px] text-slate-500 flex items-center mt-0.5 font-mono bg-slate-100 px-2 py-0.5 rounded w-fit">
    ...
    <form wire:submit.prevent="isProcessing = true; $wire.processTransfer().finally(() => { isProcessing = false })"
        class="flex-1 flex flex-col" x-data="{
            ...
            handleInput(e) {
                ...
                // 2. [BARU] Batasi Maksimal 15 Digit
        ...
        <div class="flex flex-col items-center justify-center mt-6">
            ...
            {{-- [PERBAIKAN UI] --}}
            {{-- Menggunakan Flexbox items-baseline agar Rp dan Angka sejajar rapi --}}
