            ...
            <div class="overflow-y-auto p-6">
                <form wire:submit="isEditMode ? update : store">
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        <button type="submit"
                            class="flex-1 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-600/30 transition text-sm flex justify-center items-center">
                            <span wire:loading.remove>{{ $isEditMode ? 'Simpan Perubahan' : 'Buat Akun' }}</span>
