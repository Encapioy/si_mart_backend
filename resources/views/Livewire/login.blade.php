<div class="min-h-screen w-full flex items-center justify-center bg-[#F3F4F6] py-10 px-4 font-sans">
    ...
    {{-- Card Container --}}
    <div
        class="bg-white p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-white/50 relative overflow-hidden">

        {{-- Hiasan Background Abstrak --}}
        <div
            class="absolute top-0 right-0 -mt-10 -mr-10 w-32 h-32 bg-blue-500 rounded-full blur-3xl opacity-10 pointer-events-none">
        </div>
        <div
            class="absolute bottom-0 left-0 -mb-10 -ml-10 w-32 h-32 bg-indigo-500 rounded-full blur-3xl opacity-10 pointer-events-none">
        </div>

        {{-- Header --}}
        <div class="text-center mb-8 relative z-10">
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Masuk <span class="text-blue-600">SI
                    PAY</span></h1>
        ...
        <form wire:submit="login" class="relative z-10">
            ...
            <div class="mb-5 group">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-slate-400 group-focus-within:text-blue-500 transition" fill="none"
            ...
            <div class="mb-8 group" x-data="{ showPass: false }">
                ...
                <div class="relative">
                    ...
                    <input wire:model="password" :type="showPass ? 'text' : 'password'"
                    ...
                    <button type="button" @click="showPass = !showPass"
                        class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none cursor-pointer transition">
        ...
        <div class="mt-8 text-center relative z-10">
            ...
            <a href="{{ route('register') }}"
                class="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-blue-50 text-blue-600 text-xs font-bold hover:bg-blue-100 transition duration-200 border border-blue-100">
                Daftar Akun Baru
            </a>
        </div>
    </div>
